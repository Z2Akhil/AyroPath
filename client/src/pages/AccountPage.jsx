...
import { User, Edit3, Save, Phone, Lock, Loader, ShoppingCart, FileText, Mail, MapPin, Calendar, Package as PackageIcon, AlertCircle, CheckCircle, Clock } from 'lucide-react';
...
const AccountPage = () => {
  ...
  const handleProfileSave = async (e) => {
    ...
    try {
      const result = await updateProfile({
        firstName,
        lastName,
        email, // Email is sent but backend will validate it's not changed
        mobileNumber,
        address,
        city,
        state
  ...
  // Filter active orders (not completed/cancelled/failed)
