        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl">
            ...
            <div className="rounded-xl overflow-hidden border">
              ...
              {/* Simplified Summary - Points to Form for actual pricing */}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-500 mt-1 font-bold">
                      <span className="text-red-500">Note : </span>final price will be calculated based on number of people
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-gray-500">Starting from</p>
                    <p className="text-lg font-bold text-blue-700">
                      ₹{cart?.productTotal?.toFixed(0) || '0'}
                    </p>
                  </div>
                </div>
              </div>
