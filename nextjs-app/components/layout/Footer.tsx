      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className={`overflow-hidden transition-all duration-300 md:block ${openSection === 'links' ? 'max-h-96 mt-3' : 'max-h-0 md:max-h-none'}`}>
              <li>
                <Link href="/" className="text-gray-300 hover:text-blue-400 transition-colors flex items-center gap-2 mt-2">
                  <span className="w-1 h-1 bg-blue-400 rounded-full"></span>
                  Home
                </Link>
              </li>
              <li>
                <Link href="/packages" className="text-gray-300 hover:text-blue-400 transition-colors flex items-center gap-2">
                  <span className="w-1 h-1 bg-blue-400 rounded-full"></span>
                  Popular Packages
                </Link>
              </li>
              <li>
                <Link href="/tests" className="text-gray-300 hover:text-blue-400 transition-colors flex items-center gap-2">
                  <span className="w-1 h-1 bg-blue-400 rounded-full"></span>
                  All Tests
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className={`overflow-hidden transition-all duration-300 md:block ${openSection === 'services' ? 'max-h-96 mt-3' : 'max-h-0 md:max-h-none'}`}>
              {[
          ...
          <div>
            ...
            <div className={`overflow-hidden transition-all duration-300 md:block ${openSection === 'contact' ? 'max-h-96 mt-3' : 'max-h-0 md:max-h-none'}`}>
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-sm text-gray-400">
              <p>&copy; {new Date().getFullYear()} Ayropath. All rights reserved. | In association with ThyroCare</p>
            </div>
